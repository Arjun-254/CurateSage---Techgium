      ...
      <div className="py-12 sm:py-10">
        <div className=" mx-auto max-w-7xl px-6 lg:px-8">
          <div className=" sticky mx-auto max-w-2xl lg:text-center">
            <h2 className=" font-semibold text-xl  leading-7 text-indigo-600">
          ...
          <div className="mx-auto mt-16 max-w-2xl sm:mt-20 lg:mt-12 lg:max-w-4xl">
            <dl className="grid max-w-xl grid-cols-1 gap-y-10 gap-x-8 lg:max-w-none lg:grid-cols-2 lg:gap-y-16">
              <div className="relative pl-0 sm:pl-0 md:pl-16">
                <dt className="inline font-bold bg-gradient-to-r from-violet-600 to-blue-700 bg-clip-text text-transparent">
                  <div className="absolute top-0 left-0 sm:flex h-10 w-10 items-center justify-center rounded-lg lg:block hidden">
                    <svg
